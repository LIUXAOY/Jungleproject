...
public class Chessboard {
    ...
    public boolean isValidMove(ChessboardPoint src, ChessboardPoint dest) {
        ...
        if (getChessPieceAt(src) != null){
            if(getChessPieceAt(src).getRank() == 1){//老鼠的常规移动目前无问题。
            ...
            if(getChessPieceAt(src).getRank() == 6 | getChessPieceAt(src).getRank() == 7){
                ...
                if(src.getRow() == dest.getRow() & calculateDistance(src, dest) == 3){
                    Points.add("(3,0)");
                    Points.add("(4,0)");
                    Points.add("(5,0)");
                    Points.add("(3,3)");
                ...
                if(src.getCol() == dest.getCol() & calculateDistance(src, dest) == 4){
                    Points.add("(2,1)");
                    Points.add("(2,2)");
                    Points.add("(6,1)");
                    Points.add("(6,2)");
